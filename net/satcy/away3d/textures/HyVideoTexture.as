package net.satcy.away3d.textures
{
	...
	public class HyVideoTexture extends BitmapTexture
	{
		...
		public function HyVideoTexture(source : String, materialWidth : uint = 256, materialHeight : uint = 256, loop : Boolean = true, autoPlay : Boolean = false, player : IVideoPlayer = null)
		{
			...
			_player.height = _materialHeight*1.5;
		...
		public function update() : void
		{
			...
			if (_player.playing && !_player.paused) {
				bitmapData.lock();
				bitmapData.fillRect(_clippingRect, 0x000000);
