package net.satcy.animation{
	public class OF{
		...
		private static const F3:Number =  0.333333333;
		private static const G3:Number =  0.166666667;
				/* 3D simplex noise */
		private static function _slang_library_noise3 (x:Number, y:Number, z:Number):Number{
		...
		private static const perm:Array = [151,160,137,91,90,15,
		...
		private static function grad3(  hash:int,  x:Number,  y:Number ,  z:Number ):Number {
